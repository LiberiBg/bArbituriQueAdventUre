...
public abstract class Personnage {
	...
	public int getVitesseHorizontale() {
		return this.vitesseHotizontale;
	}

	public void setVitesseVerticale(int i) {
		this.vitesseVerticale = i;
	}

	public void setVitesseHorizontale(int i) {
		this.vitesseHotizontale = i;
	}
